 ...
 */
final class Version20220721150952 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dispose (id INT AUTO_INCREMENT NOT NULL, animal_id INT DEFAULT NULL, person_id INT DEFAULT NULL, nb INT NOT NULL, INDEX IDX_6262E0668E962C16 (animal_id), INDEX IDX_6262E066217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
